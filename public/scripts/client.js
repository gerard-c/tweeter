$(() => { // page must load before anything else happens
  ...
  // used to prevent malicious users from injecting scripts via tweet textarea
  const escape = (str) => {
  ...
  // hides/shows "new tweet" area, focuses textarea on show
  ...
  $('form').submit(function(event) {
    ...
    // if no errors, textarea data is sent to database with other tweets, the "new tweet" form is
